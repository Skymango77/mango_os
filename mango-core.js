            ...
            const html = `
                ...
                <nav class="global-taskbar-wrapper">
                    <div class="global-taskbar-container">
                        ...
                        <div class="taskbar-item" onclick="MangoCore.navigate('Chat/index.html')"><i data-lucide="message-circle" class="w-6 h-6"></i><span class="text-[9px] font-black uppercase">Connect</span></div>
